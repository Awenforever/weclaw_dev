...
- Current public pre-release: `v0.1.9-alpha` at `refreshing at p0.1.5a69; verify by tag after release`.
- Current Release internal marker: `p0.1.5a69-release-v0.1.9-alpha-refresh` at `refreshing; verify by tag after release`
- Current internal development tag: `p0.1.5a69-release-v0.1.9-alpha-refresh`
- Last audited handoff baseline before this sync: `main=origin/main=p0.1.5a59-status-paths-restore=68ca2bb`
- Current active development line: `p0.1.5a69-release-v0.1.9-alpha-refresh`. Resolve its exact commit from Git instead of trusting a copied static hash.
...
| Release readiness | README, handbooks, development log, focused tests, full tests, Release notes, and five platform assets are consistent before public Release publication. | Current pre-release `v0.1.9-alpha`; internal line `p0.1.5a69-release-v0.1.9-alpha-refresh` | in_progress | 2026-05-17 | Refreshes `v0.1.9-alpha` from the earlier a60 release commit to the current a69 release commit so a61-a67 status telemetry polish is included in public assets. |
